...
/*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
#define DSM_ERROR2_TYPE 2
#define DSM_ERROR3_TYPE 3
#define DSM_ERROR4_TYPE 4
#define DSM_ERROR5_TYPE 5
#define DSM_ERROR6_TYPE 6
#define DSM_ERROR7_TYPE 7
#define DSM_ERROR8_TYPE 8
#define DSM_ERROR9_TYPE 9
#define DSM_ERROR10_TYPE 10
#define DSM_ERROR11_TYPE 11
#define DSM_ERROR12_TYPE 12
#define DSM_ERROR13_TYPE 13
#define DSM_ERROR14_TYPE 14
#define DSM_ERROR15_TYPE 15
#define DSM_ERROR16_TYPE 16
#define DSM_ERROR17_TYPE 17
#define DSM_ERROR18_TYPE 18
/*DTS2016121210411  zhuyan  zwx429344 20161214 end */
...
struct dsm_client *codec_audio_dclient = NULL;
int codec_dsm_report_err(int errno,int type)
{
	int size = 0;
	if (FACTORY_BOOT == get_boot_mode() )
           return 0;
       /*DTS2016121210411  zhuyan  zwx429344 20161213 begin */
       if (!codec_audio_dclient) {
           CODEC_ERR("%s: codec audio dclient is null\n", __func__);
           return 0;
       }
       /*DTS2016121210411  zhuyan  zwx429344 20161213 end */
	...
	CODEC_INFO("dsm error, errno = %d \n", errno);
        ...
        if(type==20)
        size = dsm_client_record(codec_audio_dclient,"Headphone swtich to ground GetGPIO_Info FAIL\n");
...
#ifdef CONFIG_HUAWEI_DSM
            /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
            codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR2_TYPE);
            /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
            /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
            codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR3_TYPE);
            /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
                /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
                codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR4_TYPE);
                /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
                /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
                codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR5_TYPE);
                /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
                /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
                codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR6_TYPE);
                /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
            /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
            codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR7_TYPE);
            /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
            /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
            codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR8_TYPE);
            /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
                /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
                codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR9_TYPE);
                /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
                /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
                codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR10_TYPE);
                /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
                /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
                codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR11_TYPE);
                /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
            /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
            codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR12_TYPE);
            /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
                /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
                codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR13_TYPE);
                /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
                /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
                codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR14_TYPE);
                /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
            /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
            codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR15_TYPE);
            /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
            /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
            codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR16_TYPE);
            /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
            /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
            codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR17_TYPE);
            /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
#ifdef CONFIG_HUAWEI_DSM
            /*DTS2016121210411  zhuyan  zwx429344 20161214 begin */
            codec_dsm_report_err(DSM_CODEC_ERROR, DSM_ERROR18_TYPE);
            /*DTS2016121210411  zhuyan  zwx429344 20161214 end */
#endif
/*DTS2016121210411  zhuyan  zwx429344 20161212 end */
		pr_err("return -EINVAL\n");
...
/*DTS2017031305823 wanli 20170312 begin*/
static void mtk_mt6323_codec_dev_shutdown(struct platform_device *pdev)
{
       pr_debug("%s\n", __func__);
       pmic_set_ana_reg(AUDTOP_CON6, 0x17E2, 0xFFFF);
       mdelay(3500);
       pmic_set_ana_reg(AUDTOP_CON6, 0x15E2, 0xFFFF);
}
/*DTS2017031305823 wanli 20170312 end*/
