...
/* DTS2017041000143 wwx427562 2017-04-11 begin */
#define DEBUG_SOC_WRITE_MAX_SIZE 256
/* DTS2017041000143 wwx427562 2017-04-11 end */
			...
			size_t count, loff_t *pos)
{
	int ret = 0;
    /* DTS2017041000143 wwx427562 2017-04-11 begin */
    char InputString[DEBUG_SOC_WRITE_MAX_SIZE];
    /* DTS2017041000143 wwx427562 2017-04-11 end */
	char *token1 = NULL;
	char *token2 = NULL;
	char *token3 = NULL;
	...
	char delim[] = " ,";
    /* DTS2017041000143 wwx427562 2017-04-11 begin */
    if (count > DEBUG_SOC_WRITE_MAX_SIZE) {
       pr_debug(" input count is to long,write fail count=%zu \n",count);
       return -EINVAL;
    }
    /* DTS2017041000143 wwx427562 2017-04-11 end */
