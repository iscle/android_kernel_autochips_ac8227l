...
/* < DTS2016112500633  yanfei/mwx333388 20161125 begin */
#else
		upmu_set_rg_drv_32k_ck_pdn(0x0);
		upmu_set_rg_isink0_ck_pdn(0x0);
		upmu_set_rg_isink0_ck_sel(0x0);
		/*DTS2016122303659:rentianzhi WX430340,@20170114,begin */
		upmu_set_isink_ch0_mode(ISINK_PWM_MODE);
		/* < DTS2016122401449:xiongzu'an WX429315 20170326 begin */
		upmu_set_isink_ch0_step(0x00);
		/* DTS2016122401449:xiongzu'an WX429315 20170326 end >*/
		upmu_set_isink_dim0_duty(duty);
		upmu_set_isink_dim0_fsel(pmic_freqsel_array[time_index]);
		 /*DTS2016122303659 rentianzhi WX430340,@20170114,end */
...
/* DTS2016112500633  yanfei/mwx333388 20161125 end >*/
#endif
		break;
	case MT65XX_LED_PMIC_NLED_ISINK1:
#ifdef PMIC_MT6325
...
/* < DTS2016112500633  yanfei/mwx333388 20161125 begin */
		...
		upmu_set_isink_dim0_fsel(0x0);
		upmu_set_isink_ch0_step(0x1);
		upmu_set_isink_chop0_en(0x0);
/* DTS2016112500633  yanfei/mwx333388 20161125 end >*/
#endif
...
/* < DTS2016112500633  yanfei/mwx333388 20161125 begin */
		...
		upmu_set_rg_isink1_ck_sel(0x0);
		upmu_set_isink_dim1_duty(15);
		upmu_set_isink_dim1_fsel(0x0);
		upmu_set_isink_ch0_mode(0x0);
		/* < DTS2017031706878  rentianzhi WX430340 20170317 begin */
		upmu_set_isink_ch1_step(0x1);//4ma
		/* DTS2017031706878  rentianzhi WX430340 20170317 end >*/
		upmu_set_isink_chop1_en(0x0);
/* DTS2016112500633  yanfei/mwx333388 20161125 end >*/
#endif
...
/* < DTS2016112500633  yanfei/mwx333388 20161125 begin */
		...
		upmu_set_rg_isink2_ck_sel(0x0);
		upmu_set_isink_dim2_duty(15);
		upmu_set_isink_dim2_fsel(0x0);
		upmu_set_isink_ch0_mode(0x0);
		upmu_set_isink_ch2_step(0x3);
		upmu_set_isink_chop2_en(0x0);
/* DTS2016112500633  yanfei/mwx333388 20161125 end >*/
#endif
