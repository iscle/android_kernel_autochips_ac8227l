...
/* < DTS2017022406895 yanwenlong/ywx422246 20170301 begin */
	struct device_node *ddrphy_node = NULL;
/* DTS2017022406895 yanwenlong/ywx422246 20170301 end > */
#endif
	...
	/* < DTS2017022406895 yanwenlong/ywx422246 20170301 begin */
	ddrphy_node = of_find_compatible_node(NULL, NULL, "mediatek,mt8127-ddrphy");
	if (ddrphy_node) {
		/* Setup IO addresses */
		g_ddrphy_base = of_iomap(ddrphy_node, 0);
		if (!g_ddrphy_base) {
			FH_MSG("g_ddrphy_base = 0x%lx\n", (unsigned long)g_ddrphy_base);
			return;
		}
	}
	/* DTS2017022406895 yanwenlong/ywx422246 20170301 end > */
