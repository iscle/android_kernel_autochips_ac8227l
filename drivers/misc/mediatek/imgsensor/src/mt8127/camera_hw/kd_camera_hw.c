...
#endif
/*DTS2017010701583  by yangyale/ywx429347 begin */
#define REAR_CAMERA_IDX  0
#define FRONT_CAMERA_IDX 1
/*DTS2017010701583  by yangyale/ywx429347 end */
/* GPIO Pin control*/
...
#define VOL_1000 1000000
	...
	if (On) {
		...
		/*< DTS2016111805543 yangyale/lwx352794 20161118 begin */
             /*DTS2017010701583  by yangyale/ywx429347 begin */
             else if (pinSetIdx == FRONT_CAMERA_IDX &&currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_MIPI_RAW, currSensorName)))
             {
             /*DTS2017010701583  by yangyale/ywx429347 end */
                //First Power Pin low and Reset Pin Low
                 ...
                 if (GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMRST]) {
                    mtkcam_gpio_set(1-pinSetIdx, CAMRST,GPIO_OUT_ZERO);
                 }
                ...
                if(TRUE != _hwPowerOnCnt(pinSetIdx, VCAMD, VOL_1800, mode_name))
                {
                 ...
                 //enable active sensor
                 if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN]) {
                     if(mtkcam_gpio_set(pinSetIdx, CAMPDN,GPIO_OUT_ZERO)){PK_DBG("[CAMERA LENS] set gpio failed!! (CMPDN)\n");}
                 }
                 mdelay(10);
                 if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) {
                     if(mtkcam_gpio_set(pinSetIdx, CAMRST,GPIO_OUT_ONE)){PK_DBG("[CAMERA SENSOR] set gpio failed!! (CMRST)\n");}
                 }
                 /*DTS2016121903793  by yangyale/ywx429347 end */
             }
             /*DTS2017010701583  by yangyale/ywx429347 begin */
             else if (pinSetIdx == REAR_CAMERA_IDX &&currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP2509_REAR_MIPI_RAW, currSensorName)))
             {
             /*DTS2017010701583  by yangyale/ywx429347 end */
                //First Power Pin low and Reset Pin Low
                 if (GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMPDN]) {
             ...
             /*DTS2017010701583  by yangyale/ywx429347 begin */
             else if (pinSetIdx == REAR_CAMERA_IDX &&currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2375_REAR_MIPI_RAW, currSensorName)))
             {
             /*DTS2017010701583  by yangyale/ywx429347 end */
                //First Power Pin low and Reset Pin Low
                 if (GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMPDN]) {
             ...
             /*DTS2017010701583  by yangyale/ywx429347 begin */
             else if (pinSetIdx == FRONT_CAMERA_IDX &&currSensorName && (0 == strcmp(SENSOR_DRVNAME_GC2375_MIPI_RAW, currSensorName)))
             {
             /*DTS2017010701583  by yangyale/ywx429347 end */
                //First Power Pin low and Reset Pin Low
                 if (GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMPDN]) {
		...
		if (pinSetIdx == 0 && currSensorName && (0 == strcmp(currSensorName, SENSOR_DRVNAME_OV5647_RAW))) {
            ...
            /*DTS2017010701583  by yangyale/ywx429347 end */
                 if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) {
                    if(mtkcam_gpio_set(1-pinSetIdx, CAMRST,GPIO_OUT_ZERO)){PK_DBG("[CAMERA SENSOR] set gpio failed!! (CMRST)\n");}
                }
               if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN]) {
                   if(mtkcam_gpio_set(1-pinSetIdx, CAMPDN,GPIO_OUT_ONE)){PK_DBG("[CAMERA LENS] set gpio failed!! (CMPDN)\n");}
                }
                if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) {
                    if(mtkcam_gpio_set(pinSetIdx, CAMRST,GPIO_OUT_ZERO)){PK_DBG("[CAMERA SENSOR] set gpio failed!! (CMRST)\n");}
                }
               mdelay(1);
               if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN]) {
                   if(mtkcam_gpio_set(pinSetIdx, CAMPDN,GPIO_OUT_ONE)){PK_DBG("[CAMERA LENS] set gpio failed!! (CMPDN)\n");}
                }
               mdelay(1);
               if(TRUE != _hwPowerDownCnt(pinSetIdx, VCAMIO, mode_name))
               {
