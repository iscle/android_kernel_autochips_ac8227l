...
int iReadRegI2C(u8 *a_pSendData , u16 a_sizeSendData, u8 * a_pRecvData, u16 a_sizeRecvData, u16 i2cId)
{
    int  i4RetValue = 0;
	    ...
	    if (i4RetValue != a_sizeSendData) {
	        ...
	        #ifdef CONFIG_HUAWEI_DSM
	        if(g_IsSearchSensor !=1)
			camera_report_dsm_err_i2c(i2cId,a_pSendData[0],"iReadReg I2C send failed!");
	        #endif
	        /* DTS2016122308780 yangyale ywx429347 20161222 end >*/
	    ...
	    if (i4RetValue != a_sizeRecvData) {
	        ...
	        #ifdef CONFIG_HUAWEI_DSM
	        if(g_IsSearchSensor !=1)
			camera_report_dsm_err_i2c(i2cId,a_pSendData[0],"iReadReg I2C read failed!");
	        #endif
	        /* DTS2016122308780 yangyale ywx429347 20161222 end >*/
	        PK_DBG("[CAMERA SENSOR] I2C read failed!! \n");
	        return -1;
...
/* DTS2016121315044 ywx429347 20161213 begin */
static  int kdSensorSetHardwareInfo(sensor_version *pbuf)
{
    int ret  = 0;
    sensor_version *cfg_version = (sensor_version *)pbuf;
    if(cfg_version->InvokeCamera == DUAL_CAMERA_MAIN_SENSOR){
        printk("%s resister main sensor  hardware info success\n ",cfg_version->name);
        /* DTS2016121315044 ywx429347 20161213 begin */
        #ifdef CONFIG_GET_HARDWARE_INFO
        register_hardware_info(MAIN_CAM,cfg_version->name);
        #endif
        /* DTS2016121315044 ywx429347 20161213 end */
     }
    if(cfg_version->InvokeCamera == DUAL_CAMERA_SUB_SENSOR){
        printk("%s resister sub sensor  hardware info success\n ",cfg_version->name);
        /* DTS2016121315044 ywx429347 20161213 begin */
        #ifdef CONFIG_GET_HARDWARE_INFO
        register_hardware_info(SUB_CAM,cfg_version->name);
        #endif
        /* DTS2016121315044 ywx429347 20161213 end */
     }
    return ret;
...
/* DTS2016121315044 ywx429347 20161213 begin*/
        case KDIMGSENSORIOC_X_SET_SHUTTER_GAIN_WAIT_DONE:
            ...
            break;
        case KDIMGSENSORIOC_X_SET_HARDWARE_INFO:
            i4RetValue = kdSensorSetHardwareInfo((sensor_version*)pBuff);
            break;
/* DTS2016121315044 ywx429347 20161213 end*/
