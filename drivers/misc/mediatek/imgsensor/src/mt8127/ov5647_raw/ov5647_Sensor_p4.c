...
#if 0 /*remove unused function*/   // Houston 20131003 decrease capture frame rate due to pclk can't reach to 80MHz
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	pSensorInfo->PreviewDelayFrame = 1;//1; // Houston 20130917 increase pv delay frame to fix pclk phase shift
...
//	UINT32 i;
	...
	case SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO:
		OV5647SetMaxFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, *(pFeatureData32 + 1));
		break;
	case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
		OV5647GetDefaultFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData32, (MUINT32 *)(*(pFeatureData32 + 1)));
		break;
