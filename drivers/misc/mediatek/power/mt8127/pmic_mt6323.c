...
#define PMIC_VCHR_CHANL_NUM 4
#define PMIC_TIMES 5
#define PMIC_R_CHR_1 330
#define PMIC_R_CHR_2 39
#define PMIC_PERMETER 100
...
static void chr_det_work_handle(struct work_struct *work);
...
/* DTS2017022306151  rentianzhi WX430340 20170313 begin >*/
static DECLARE_DELAYED_WORK(chr_det_work, chr_det_work_handle);
/* DTS2017022306151 rentianzhi WX430340 20170313 end> */
...
static irqreturn_t chrdet_int_handler(int irq, void *dev_id)
{
	...
	if (!upmu_get_rgs_chrdet()) {
		int boot_mode = 0;
		/*< DTS2017032800426 rentianzhi WX430340 20170329 begin */
		signed int chr_hlr_VChr = 0;
		/* DTS2017032800426 rentianzhi WX430340 20170329 end> */

		boot_mode = get_boot_mode();
		/*< DTS2017032800426 rentianzhi WX430340 20170329 begin */
		chr_hlr_VChr = PMIC_IMM_GetOneChannelValue(PMIC_VCHR_CHANL_NUM, PMIC_TIMES, 1);
		chr_hlr_VChr = (((PMIC_R_CHR_1+PMIC_R_CHR_2)*PMIC_PERMETER*chr_hlr_VChr)/PMIC_R_CHR_2) / PMIC_PERMETER;
		pr_err("=============chr_hlr_VChr:%d============\n",chr_hlr_VChr);
		/* DTS2017032800426 rentianzhi WX430340 20170329 end> */

		/*< DTS2017030400825 rentianzhi WX430340 20170314 begin */
		if ((boot_mode == KERNEL_POWER_OFF_CHARGING_BOOT
		    || boot_mode == LOW_POWER_OFF_CHARGING_BOOT)  &&( chr_hlr_VChr < VBUS_DET_THOD_3300MV)) {
		/* DTS2017030400825 rentianzhi WX430340 20170314 end> */
			pr_notice
...
#endif
	/* DTS2017022306151  rentianzhi WX430340 20170313 begin >*/
	schedule_delayed_work(&chr_det_work, 0);
	/* DTS2017022306151 rentianzhi WX430340 20170313 end> */
	return IRQ_HANDLED;
}
				 ...
				 size_t size)
{
	...
	/*<DTS2017041000099 liumaoxin WX422269 20170410 begin */
	if (size > 32)
		return -EINVAL;
	/*<DTS2017041000099 liumaoxin WX422269 20170410 end> */
	strcpy(temp_buf, buf);
	pvalue = temp_buf;
