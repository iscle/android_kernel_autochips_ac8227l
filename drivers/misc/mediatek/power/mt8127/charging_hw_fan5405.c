...
/*DTS2016122305491 liuguangchao/lwx422269  20161222 begin >*/
/*Modify  the IBAT register value  set reg[2:0] */
#define CHARGING_TERMINAL_CURRENT_100MA		0x01
/*DTS2016122305491 liuguangchao/lwx422269  20161222 end >*/
/* ============================================================ // */
/* Global variable */
/* ============================================================ // */
...
const u32 CS_VTH[] = {
	...
	/*DTS2016122305491 liuguangchao/lwx422269  20161222 begin >*/
	/*modify for charge chip,from the spec we can see the charge current is set through REG4[6:4] */
	/*<00 01 02 03 04 05 06 07>----<550 650 750 850 950 1050 1150 1250 > */
...
static u32 charging_hw_init(void *data)
{
	...
	if (!charging_init_flag) {
		fan5405_reg_config_interface(0x04, 0x1B);	/* 192mA */
...
static u32 charging_set_current(void *data)
{
	...
	/*DTS2016122305491 liuguangchao/lwx422269  20161222 begin >*/
	fan5405_set_iterm(CHARGING_TERMINAL_CURRENT_100MA);
	/*DTS2016122305491 liuguangchao/lwx422269  20161222 end >*/
	return status;
}
